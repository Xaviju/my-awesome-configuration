...
-- {{{ Wallpaper
theme.wallpaper = "/home/xaviju/.config/awesome/themes/holo/bg01.jpg"
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey }, "p", function() os.execute("ksnapshot") end),
    ...
    awful.key({ modkey, altkey }, "i", function () awful.util.spawn(graphics) end),
    awful.key({ modkey, altkey }, "b", function () awful.util.spawn(browser) end),
    awful.key({ modkey, altkey }, "f", function () awful.util.spawn(browser2) end),
